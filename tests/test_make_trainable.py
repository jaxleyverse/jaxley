...
def test_diverse_synapse_types(SimpleNet):
    ...
    all_parameters = net.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
...
def get_params_subset_trainable(net):
    ...
    net.to_jax()
    pstate = params_to_pstate(params, net.indices_set_by_trainables)
    return net.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
...
def test_make_trainable_corresponds_to_set_pospischil(SimpleNet):
    ...
    all_params1 = net1.get_all_parameters(pstate1, voltage_solver="jaxley.dhs.cpu")
    ...
    all_params2 = net2.get_all_parameters(pstate2, voltage_solver="jaxley.dhs.cpu")
...
def test_group_trainable_corresponds_to_set():
    ...
    all_parameters1 = net1.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
    ...
    all_parameters2 = net2.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
...
def test_data_set_vs_make_trainable_pospischil(SimpleNet):
    ...
    net2.to_jax()
    all_params2 = net2.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
    assert np.array_equal(all_params1["vt"], all_params2["vt"], equal_nan=True)
    assert np.array_equal(all_params1["Na_gNa"], all_params2["Na_gNa"], equal_nan=True)
    assert np.array_equal(all_params1["K_gK"], all_params2["K_gK"], equal_nan=True)
...
def test_param_sharing_w_different_group_sizes():
    ...
    params1 = branch1.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
    ...
    params2 = branch2.get_all_parameters(pstate, voltage_solver="jaxley.dhs.cpu")
